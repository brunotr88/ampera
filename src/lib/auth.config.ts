...
export const authConfig = {
  ...
  callbacks: {
    authorized({ auth, request: { nextUrl } }) {
      ...
      // Public
      if (pathname.startsWith("/api/auth") || pathname.startsWith("/api/health") || pathname === "/login" || pathname.startsWith("/_next") || pathname === "/" || pathname.startsWith("/q/") || pathname.startsWith("/share/") || pathname.startsWith("/sign/") || pathname.startsWith("/track/") || pathname.startsWith("/api/public/")) {
        return true;
      }
